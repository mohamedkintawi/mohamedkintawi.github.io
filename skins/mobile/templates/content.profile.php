<div>
  ...
  <form action="{$VAL_SELF}" method="post">
	...
	{/if}
	  <p class="buttons"><input name="update" type="submit" value="{$LANG.common.update}" class="button_submit" /> <input type="reset" value="{$LANG.common.reset}" class="button_submit" /></p>
	  </form>
</div>