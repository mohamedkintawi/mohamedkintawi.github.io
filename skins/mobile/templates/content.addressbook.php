<div id="addressbook">
  <form action="{$VAL_SELF}" method="post" enctype="multipart/form-data">
	...
	<div class="buttons">
	  <input type="submit" value="{$LANG.common.delete_selected}" class="button_submit" />
  ...
  {if isset($CTRL_FORM)}
	<fieldset>
	  ...
	  <div><span><input name="billing" type="checkbox" id="addr_billing" value="1" {$DATA.billing} /></span> {$LANG.address.billing_address}</div>
	  <div><span><input name="default" type="checkbox" id="addr_default" value="1" {$DATA.default} /></span> {$LANG.address.default_delivery_address}</div>
	</fieldset>
	<div class="buttons">
