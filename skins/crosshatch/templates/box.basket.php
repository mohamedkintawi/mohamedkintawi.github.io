<div class="box" id="basketSummary">
	...
	<p class="basket_total">
		<span>{$LANG.basket.total}:</span>{$CART_TOTAL}
	</p>
	<p class="view_basket animate_basket">
		<a href="{$BUTTON.link}" title="{$BUTTON.text}" class="btnViewBasket">{$BUTTON.text}</a>
	</p>
</div>