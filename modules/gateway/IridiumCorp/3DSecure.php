<?php
require '../../../ini.inc.php';
require CC_ROOT_DIR . CC_DS . 'includes' . CC_DS . 'global.inc.php';
require CC_ROOT_DIR . CC_DS . 'includes' . CC_DS . 'functions.inc.php';
require CC_ROOT_DIR . CC_DS . 'classes' . CC_DS . 'session.class.php';
$config = $glob;
...
<html>
	...
	<body onload="onLoadHandler();" style="margin-left: auto; margin-right: auto;">
		<div name="3DS" style="margin-left: auto; margin-right: auto;">
			<form name="processform" method="post" action="<?php echo $GLOBALS['session']->get('ACSUrl', 'iridiumcorp') ?>" />
			<input type="hidden" name="PaReq" value="<?php echo $GLOBALS['session']->get('PaREQ', 'iridiumcorp') ?>" />
			<input type="hidden" name="TermUrl" value="<?php echo $GLOBALS['session']->get('TermUrl', 'iridiumcorp') ?>" />
			<input type="hidden" name="MD" value="<?php echo $GLOBALS['session']->get('CrossReference', 'iridiumcorp') ?>" />
			<noscript>
