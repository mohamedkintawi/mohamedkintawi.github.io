<?php /* Smarty version Smarty-3.1.15, created on 2018-06-28 02:51:57
         compiled from "C:\wamp64\www\admin\skins\default\templates\settings.index.php" */ ?>
<?php /*%%SmartyHeaderCode:9535b344d4d3d3d37-03119279%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '7062b386524371f63aaed457a18b2572ec6b5fe2' => 
    array (
      0 => 'C:\\wamp64\\www\\admin\\skins\\default\\templates\\settings.index.php',
      1 => 1529901918,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '9535b344d4d3d3d37-03119279',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5b344d5157c482_21808631',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5b344d5157c482_21808631')) {function content_5b344d5157c482_21808631($_smarty_tpl) {?><form id="form-settings" action="<?php echo $_smarty_tpl->tpl_vars['PHP_SELF']->value;?>
...
><?php echo $_smarty_tpl->tpl_vars['skin']->value['display'];?>
	  ...
	  <select name="config[skin_style_mobile]" id="skin_style_mobile" class="textbox select-style-mobile"></select> 
	</span></div>
...
><?php echo $_smarty_tpl->tpl_vars['option']->value['title'];?>
   	...
   	<div><label for="seo_add_cats"><?php echo $_smarty_tpl->tpl_vars['LANG']->value['settings']['title_seo_add_cats'];?>
</label><span><input name="config[seo_add_cats]" id="seo_add_cats" type="hidden" class="toggle" value="<?php echo $_smarty_tpl->tpl_vars['CONFIG']->value['seo_add_cats'];?>
" /></span></div>
...
</label><span><input name="config[dispatch_date_format]" id="dispatch_date_format" type="text" class="textbox" value="<?php if (($_smarty_tpl->tpl_vars['CONFIG']->value['dispatch_date_format'])) {?><?php echo $_smarty_tpl->tpl_vars['CONFIG']->value['dispatch_date_format'];?>
<?php } else { ?>%b %d %Y<?php }?>" /> PHP <a href="http://www.php.net/strftime" target="_blank">strftime</a></span></div>
